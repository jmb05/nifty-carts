...
public class NiftyCartsAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(HolderLookup.Provider registryLookup, Consumer<AdvancementHolder> consumer) {
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion(
                        "plow_till_ground",
                        UsePlowCriterion.TriggerInstance.usePlow(ItemPredicate.Builder.item().of(itemRegistry, ItemTags.HOES)))
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion(
                        "plow_create_path",
                        UsePlowCriterion.TriggerInstance.usePlow(ItemPredicate.Builder.item().of(itemRegistry, ItemTags.SHOVELS)))
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion(
                        "plow_strip_log",
                        UsePlowCriterion.TriggerInstance.usePlow(ItemPredicate.Builder.item().of(itemRegistry, ItemTags.AXES)))
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion("attach_banner",
                        CartAddBannerCriterion.TriggerInstance.usedBanner(ItemPredicate.Builder.item().of(itemRegistry, ItemTags.BANNERS)))
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion("hand_cart_one_k",
                        PullCartCriterion.TriggerInstance.pullCart(EntityTypePredicate.of(entityTypeRegistry, NiftyCarts.HAND_CART_ENTITY), 1000_00, 0))
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion("wagon_cart_full",
                        PullCartCriterion.TriggerInstance.pullCart(EntityTypePredicate.of(entityTypeRegistry, NiftyCarts.WAGON_ENTITY), 1, 4))
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion("animal_cart_steer", SteerCartCriterion.TriggerInstance.steerCart(EntityTypePredicate.of(entityTypeRegistry, NiftyCarts.ANIMAL_CART_ENTITY), 1))
        ...
        Advancement.Builder.advancement()
                ...
                .addCriterion("supply_cart_filled",
                        PullCartCriterion.TriggerInstance.pullCartFill(EntityTypePredicate.of(entityTypeRegistry, NiftyCarts.SUPPLY_CART_ENTITY), 1.0f))
