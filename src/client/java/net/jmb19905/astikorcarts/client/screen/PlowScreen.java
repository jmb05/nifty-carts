package net.jmb19905.astikorcarts.client.screen;
...
public final class PlowScreen extends AbstractContainerScreen<PlowMenu> {
    private static final ResourceLocation PLOW_GUI_TEXTURES = new ResourceLocation(AstikorCarts.MOD_ID, "textures/gui/container/plow.png");
