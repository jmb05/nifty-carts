...
public class WagonEntity extends AbstractDrawnInventoryEntity {
    ...
    public ResourceLocation getRoofTexture() {
        ...
        return new ResourceLocation(NiftyCarts.MOD_ID, "textures/entity/wagon_roof_" + name + ".png");
    }

    @Override
    protected void defineSynchedData() {
        super.defineSynchedData();
        this.entityData.define(UNFURL, 0);
        this.entityData.define(ROOF_COLOR, -1);
        this.entityData.define(CHEST_COUNT, 0);
        this.entityData.define(EQUIPPED_CARPET, ItemStack.EMPTY);
    }
    ...
    private InteractionResult interactCarpet(ItemStack itemStack, Player player) {
        if (itemStack.is(ItemTags.WOOL_CARPETS)) {
            ...
            if (itemStack.getCount() >= 5 || player.isCreative()) {
