...
public class CartItem extends Item {
    ...
    private final NiftyCartsWoodType woodType;
    private final String cartType;

    public CartItem(NiftyCartsWoodType woodType, String cartType, Properties settings) {
        super(settings);
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if (result.getType() == HitResult.Type.MISS) {
            ...
            if (result.getType() == HitResult.Type.BLOCK) {
                final EntityType<?> type = BuiltInRegistries.ENTITY_TYPE.get(new ResourceLocation(NiftyCarts.MOD_ID, cartType));
